...
<div class="container-fluid center_panel">
    ...
    <div id="sign-up" >
        ...
        <p class="declare">By creating an account, I accept <a href="/PrivacyPolicy" class="privacy_policy">Privacy Policy</a>.</p>
            ...
            $.post(
                    ...
                    function (message) {
                        ...
                        if(messageCode == 1 && statusCode==1){
                            ...
                            if(exist){
                                emailFlag = false;
                               megdiv2.show().children("p").html("That email's taken. <a href='/forgot/password' style='color:rgb(248,96,5)'>Forgot your password</a>?");
