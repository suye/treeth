 <input type="hidden" value="" id="connectMethod"/>
 <input type="hidden" value="" id="cancelLink"/>
<div class="topNav" role="navigation">
        ...
        <li class="emptyMessage emptyModel">
         ...
         <div class="input-group search-head">
                ...
                <input class="form-control search findList" type="search" placeholder="Search">
         </div>
            ...
            <#if (Session["USER_LOGIN_DATA"].user)??>
               <input type="hidden" name="" class="userInfo " value='${Session["USER_LOGIN_DATA"].user.id}'>
                ...
                <div  class=" btn btn-default dropdown messagePart" id="privateletter">
                  ...
                  <ul class="dropdown-menu  messageLists closedropdown" role="menu">
                    <li class="messageList"></li>
                ...
                <div  class="advicePart mybtns btn btn-default dropdown " id="sysMessage">
                  ...
                  <ul class="dropdown-menu  closedropdown advices" role="menu">
        ...
        <ul class="login">
            ...
            <li class="ftg">
                <ul class="list-inline">
                    ...
                    <li><a href="javascript:" id="facebook"><img src="${localPath}/img/log-in-facebook01.png"></a></li>
                    <li class="center-li"><a href="javascript:" id="twitter"><img src="${localPath}/img/log-in-twitter01.png"></a></li>
                    <li><a href="javascript:" id="google"><img src="${localPath}/img/log-in-google_plus01.png"></a></li>
                </ul>
            </li>
            <li class="p login-p">
                <form role="form">
...
<div class="speModal modal fade postModal layer_mask" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        ...
        <form class="form-horizontal infos uploadForm" role="form" method="post" enctype="multipart/form-data" action="">
        ...
        <div class="uploadImgs clearfix upload" >
            ...
            <div class="col-xs-6 typeRequires">That filetype is not supported.</div>
        </div>
        <div class="videoInfo">
            <div class="back"></div>
            <div class="form-group">
             ...
             <div class="row uploadWarn ">
                ...
                <div class="col-xs-12 videoValidate">That video type is not supported</div> 
             </div>
        </div>
      <div class="upload clearfix uploadChose">
            ...
            <div class="row uploadWarn">
                ...
                <div class="col-xs-6 typeRequire">That file type is not supported.</div>
            </div>
         </div> 
        ...
        <div class="info">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-10">
                  <input type="hidden" name="description" class="mydesc">
                  <textarea  name="" id="desc" class=" form-control" cols="20" rows="5" placeholder="What's your post about?" ></textarea>
              ...
              <div class="form-group ">
                <label class="control-label col-xs-2 interTag" for="inputPassword">Interest Tag</label>
                
                <div class="col-xs-10 tagsInit">
                ...
                <label class="control-label col-xs-2" for="game">Game</label>
                 ...
                 <div class=" col-xs-10">
                    ...
                    <div  class="searchGame"> 
                        ...
                        <img src="${localPath}/img/gameIcon.png" alt="" class="gameimg">
