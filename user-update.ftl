...
<div class="container-fluid center_panel">
    ...
    <div class="settings" >
        ...
        <div class="socialNet">
                ...
                <li class="connect"><label class="radio-inline firstLabel smallFont"><img src="${localPath}/img/log-in-facebook01.png"><span id = "facebookConnect">
                ...
                <li class="connect "><label class="radio-inline firstLabel">Log in with Facebook</label>
                    <label class="radio-inline">
                      <#if Request.userConnectFacebook??>
                        <#if Request.userConnectFacebook>
                         <input type="button" class="btn btn-default socialOff socialOn connectFacebook" value="on"  id="facebookDisconnectBtn">
                        <#else>
                         <input type="button" class="btn btn-default socialOff cancelFacebook"  id="facebookConnectBtn" value="off">
                        </#if>
                      </#if>
                    </label>
              ...
              <!--   <li class="connect"><label class="radio-inline firstLabel">Link to Timeline</label>
                ...
                <li class="connect"><label class="radio-inline firstLabel">Log in with Twitter</label>
                    <label class="radio-inline">
                      <#if Request.userConnectTwitter??>
                        <#if Request.userConnectTwitter>
                         <input type="button" class="btn btn-default socialOff socialOn connectTwitter" value="on" id="twitterDisconnectBtn">
                        <#else>
                         <input type="button" class="btn btn-default socialOff cancelTwitter" value="off" id="twitterConnectBtn">
                        </#if>
                      </#if>
                    </label>
                ...
                <li class="connect"><label class="radio-inline firstLabel">Connect with Google+</label>
                    <label class="radio-inline">
                       <#if Request.userConnectGoogleplus??>
                        <#if Request.userConnectGoogleplus>
                         <input type="button" class="btn btn-default socialOff socialOn connectGoogleplus" value="on" id="googleplusDisconnectBtn" >
                        <#else>
                         <input type="button" class="btn btn-default socialOff cancelGoogleplus" value="off" id="googleplusConnectBtn" >
                        </#if>
                      </#if>
                    </label>
                ...
                <li class="connect"><label class="radio-inline firstLabel smallFont"><img src="${localPath}/img/yahoo.png">
                    <span id="yahooConnect">
                      <#if Request.userConnectYahoo??>
                        <#if Request.userConnectYahoo>
                          Connected
                        <#else>
                          Not Connect
                    ...
                    <label class="radio-inline"></label></li>
                <li class="connect"><label class="radio-inline firstLabel">Connect with Yahoo</label>
                    <label class="radio-inline">
                       <#if Request.userConnectYahoo??>
                        <#if Request.userConnectYahoo>
                         <input type="button" class="btn btn-default socialOff socialOn connectYahoo" value="on" id="yahooDisconnectBtn" >
                        <#else>
                         <input type="button" class="btn btn-default socialOff cancelYahoo" value="off" id="yahooConnectBtn" >
                        </#if>
                      </#if>
                    </label>
                    <label class="radio-inline smallFont">
...
<input type="hidden" value="10" id="pageName"/>
 ...
 function html5Reader(file,pic){
  ...
  if(winHeight < 880){
    ...
    function floatFooter(){
     var floatFooter = {"position":"fixed","bottom":"0px","left":"50%","margin-left":"-363px","width":"724px","border-radius":"0 0 8px 8px","border":"1px solid #c3c3c3","border-right":"0"};   
     $(".lastli").css(floatFooter);

    } 

   
    $(".cancelFacebook").live("click",function(){
            var w = window.open('','newwindow','width=700,height=500,z-look=yes','center'); 
            $.get("/socialauth",{providerId:"facebook"}, function(message){

                            $("#connectMethod").val(connectMethod.facebookConnect);
    ...
    $(".cancelGoogleplus").live("click",function(){
            var w = window.open('','newwindow','width=700,height=500,z-look=yes','center'); 
            $.get("/socialauth",{providerId:"facebook"}, function(message){
    ...
    $(".connectGoogleplus").live("click",function(){
            var w = window.open('','newwindow','width=700,height=500,z-look=yes','center'); 
            $.get("/socialauth",{providerId:"facebook"}, function(message){

                            
                          
                            $("#connectMethod").val(connectMethod.googleplusDisconnect);
                            w.location.href = "/login/googleplus/";
                           //window.open(treethInterFace,'newwindow','width=800, height=500','center');                        
                },"text"
            );
    ...
    $(".cancelTwitter").live("click",function(){
            var w = window.open('','newwindow','width=700,height=500,z-look=yes','center'); 
            $.get("/socialauth",{providerId:"facebook"}, function(message){

                            $("#connectMethod").val(connectMethod.twitterConnect);
    ...
    $(".connectTwitter").live("click",function(){
            var w = window.open('','newwindow','width=700,height=500,z-look=yes','center'); 
            $.get("/socialauth",{providerId:"facebook"}, function(message){

                            
                          
                            $("#connectMethod").val(connectMethod.twitterDisconnect);
                            w.location.href = "/login/twitter/";
                           //window.open(treethInterFace,'newwindow','width=800, height=500','center');                        
                },"text"
            );
    ...
    $(".cancelYahoo").live("click",function(){
            var w = window.open('','newwindow','width=700,height=500,z-look=yes','center'); 
            $.get("/socialauth",{providerId:"facebook"}, function(message){
    ...
    $(".connectYahoo").live("click",function(){
            var w = window.open('','newwindow','width=700,height=500,z-look=yes','center'); 
            $.get("/socialauth",{providerId:"facebook"}, function(message){

                            
                          
                            $("#connectMethod").val(connectMethod.yahooDisconnect);
                            w.location.href = "/login/yahoo/";
                           //window.open(treethInterFace,'newwindow','width=800, height=500','center');                        
                },"text"
            );
