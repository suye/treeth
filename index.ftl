...
<body class="mybody ownPost indexPost">
 <#include "header.ftl"> 
...
<#if (Session["USER_LOGIN_DATA"].user)??>
	...
	<div class="testHtml" style="display:none"></div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<p class="guideContent">
			...
			There are two types of posts: image and video.
		</p>
 ...
 <button class="btn btn-primary btn-lg guideBtn4" data-toggle="modal" data-target="#guideModel4" style="display:none">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<h3>If you like anything...</h3>
		<p class="guideContent firstGuide">

			Click the heart. It's called 'liking'. 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<p class="guideContent">
			...
			Feel free to contact us and give us early <br>
			feedback on our beta version.  <br>
			Your feedback helps make Treeth better.
