...
/* 请求各项count 和帖子数目*/
               ...
               var count = 0;
                    $.get(
                        ...
                        $("#masonry").html("");
                              if(count == 0){
                                 if(currentUser == userId){
                                    $(".noContentDiv").html('<div class="pageImg"><img src="'+address+'img/Find-Posts.png"></div><div style="text-align:center;width:100%;"><p class="pageDescribe">Post anything you\'re interest in, and it will show up here.</P></div><a href="#myModal" role="button" class="btn btn-default" data-toggle="modal" data-target="#myModal" style="display:block; width:100px; margin:auto; color:rgb(248,96,5);font-weight:bold;">Add Post</a>');
                                 }else{
                                    $(".noContentDiv").html('<div class="pageImg"><img src="'+address+'img/Find-Posts.png"></div><div style="text-align:center;width:100%;"><p class="pageDescribe">'+$(".uname").html()+' has\'t post anything yet.</P></div>');
                                 }
                                }else{
                                    if(currentUser == userId){ 
                                        myauthor.html(editButton);
                                         $("#masonry").html('<div class="addpostDiv thumbnail imgModal"><a href="#myModal" class="addDiv"  data-toggle="modal" data-target="#myModal"><img src="'+address+'img/add-butten.png"/><p>Add a post</p></a></div>');
                                    }else{
                       ...
                       $("#masonry").html("");
                            if(count == 0){
                                if(currentUser == userId){
                                    ...
                                    $(".noContentDiv").html('<div class="pageImg"><img src="'+address+'img/Find-Posts-likes.png"></div><div style="text-align:center;width:100%;"><p class="pageDescribe">'+$(".uname").html()+' has\'t like any post yet.</P></div>');
                                }
                            }else{
                                   $(".noContentDiv").html("");
                                 if(currentUser == userId) 
                                 ...
                                 var elem = document.getElementById("masonry");
                                $.data(elem,"masonry","");
                                initMasonry("/likes",{"userId":userId,pageNum:1});
                            }
                        },"json"
                        );
                    ...
                    function(message){
                        ...
                        if(count == 0){
                            if(currentUser == userId){
                                ...
                                $(".noContentDiv").html('<div class="pageImg"><img src="'+address+'img/Find-Friends.png"></div><div style="text-align:center;width:100%;"><p class="pageDescribe">'+$(".uname").html()+' has\'t have any followers yet.</P></div><button role="button" class="pageOperation btn btn-default mybtns loginFollow">Follow</button>');
                            }
                        }else{
                               $(".noContentDiv").html("");
                             ...
                             var elem = document.getElementById("masonry");
                           $.data(elem,"masonry","");
                           initUserMasonry("/followers",{"userId":userId,"pageNum":1});
                        ...
                        function(message){
                            ...
                            if(count == 0){
                                    if(currentUser == userId){
                                        ...
                                        $(".noContentDiv").html('<div class="pageImg"><img src="'+address+'img/Find-Games.png"></div><div style="text-align:center;width:100%;"><p class="pageDescribe">'+$(".uname").html()+' hasn\'t follow any games yet.</P></div>');
                                    }
                             ...
                             $("#masonry").html("");
                                if(count == 0){
                                    if(currentUser == userId){
                                            ...
                                            $(".noContentDiv").html('<div class="pageImg"><img src="'+address+'img/Find-Friends.png"></div><div style="text-align:center"><p class="pageDescribe">'+$(".uname").html()+' hasn\'t follow anyone yet.</P></div>');
                                        }
                                        $(".pageImg").css("margin-top","32px");
                                }else{
                                       $(".noContentDiv").html("");
            ...
            $.get("/games",{pageNum:pageNum,pageSize:"3",lan:"0",coverUrlCount:"6",userId:userId},function(data){
                    ...
                    if(gameImgList != null && gameImgList.length > 0){
                        ...
                        $(gameImgList).each(function(){
                            ...
                            if(type == "1"){
                                ...
                                c = $('<div class="gameImg col-md-4"><input type="hidden" value="'+this.coverImg+'" class="showimg"/>'+
                                '<input type="hidden" class="postId" value="'+this.id+'">'+'<input type="hidden" value="'+this.userId+'" class="postUserId">'+'<img src="'+address+'img/play.png" alt="" class="play" style="display:inline"/></div>');
                            }else{
                                c = $('<div class="gameImg col-md-4"><input type="hidden" value="'+this.coverImg+'" class="showimg"/>'+
                                '<input type="hidden" class="postId" value="'+this.id+'">'+'<input type="hidden" value="'+this.userId+'" class="postUserId">'+
                                    '<img src="'+address+'img/play.png" alt="" class="play" style="display:none"/></div>');
            ...
            $(window).scroll(function() {
                ...
                if((!thumLengthUserFlag || !thumLengthFlag || !thumLengthGameFlag) && $(document).height() - $(window).height() - $(document).scrollTop() < height) {
