...
+function ($) {
  ...
  function clearMenus(e) {
    ...
    $(toggle).each(function () {
      ...
      var modal = $(tar).closest(".messageModels");
        var c = $(modal).attr("class");
        if(c != undefined){
          return;
        }
      ...
      if(event){
        ...
        var par = $(t).closest(".closedropdown");
        var c = $(par).attr("class");
        if(c != undefined){
          return;
        }
      }else{
        var par = $(tar).closest(".closedropdown");
        var c = $(par).attr("class");
        if(c != undefined){
          return;
        }
     ...
     /* if($parent.hasClass('closedropdown')){
        return;
      }*/
...
+function ($) {
  ...
  Modal.prototype.show = function (_relatedTarget) {
    ...
    this.backdrop(function () {
      ...
      if($(".messageModels .showMessages")[0] != undefined){
  ...
  Modal.prototype.hide = function (e) {
    ...
    if(elem){
      ...
      if(c.indexOf("moduleStep") > -1 && c.indexOf("module6") <= -1){
        return;
      }
    ...
    this.$element
      ...
      if(this.options.target == "#messageModel"){
